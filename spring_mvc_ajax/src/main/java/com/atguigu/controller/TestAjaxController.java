 ...
 * @author: MC
 * @program: SSM
 * @create: 2022-08-11 12:33
 * @Description: 1.@RequestBody:将请求体中的内容和控制器方法的形参进行绑定
 * 2,使用@RequestBody注解将json格式的请求参数转换为java对象
 * a>导入jackson依赖
 * b>在SpringMVC的配置中1设置<mvc:annotation-driven/>
 * c>在处理请求的控制器方法的形参位置,直接设置json格式的请求参数要转换java类型的形参,使用@RequestBody注解即可
 * <p>
...
@Controller
//@RestController 相当于Controller，RequestMapping
